...
# Nuevo 2020-11
def IV_FOR_DOCUMENTO(dni, tipoDocumento):
    ...
    try:
        ...
        def resolverCapcha():
            ...
            try:
                ...
                wait.until(EC.presence_of_element_located((By.NAME, 'ctl00$cplPrincipal$txtCaptcha'))).send_keys(
                    str("{}".format(jsonParse)))
                time.sleep(1)
                wait.until(EC.presence_of_element_located((By.XPATH,
                                                           '/html/body/form/div[3]/section/div/div/div[2]/div[3]/div[6]/div/div[3]/div[2]/input'))).click()
                # "/html/body/form/div[3]/section/div/div/div[2]/div[3]/div[6]/div/div[3]/div[2]/input"
                ...
                try:
                    ...
                    espero.until(EC.presence_of_element_located((By.XPATH,
                                                                 '/html/body/form/div[3]/section/div/div/div[2]/div[2]/div/select/option[3]'))).click()
                    time.sleep(2)
                    # C.E
                    if tipoDocumento == "2":
                        wait.until(EC.presence_of_element_located(
                            (By.XPATH,
                             '/html/body/form/div[3]/section/div/div/div[2]/div[3]/div[2]/div/div[2]/div[2]/select/option[3]'))).click()
                    # RUC
                    if tipoDocumento == "3":
                        wait.until(EC.presence_of_element_located(
                            (By.XPATH,
                             '/html/body/form/div[3]/section/div/div/div[2]/div[3]/div[2]/div/div[2]/div[2]/select/option[2]'))).click()
                    # PASAPORTE
                    if tipoDocumento == "4":
                        wait.until(EC.presence_of_element_located(
                            (By.XPATH,
                             '/html/body/form/div[3]/section/div/div/div[2]/div[3]/div[2]/div/div[2]/div[2]/select/option[4]'))).click()

                    print("reintentar capcha")
                    return "False"
                finally:
                    espero = WebDriverWait(driver, 2)
                    tabla = espero.until(EC.presence_of_element_located(
                        (By.XPATH, '/html/body/form/div[3]/section/div/div/div[2]/div[4]/div/div/table')))
                    print("Leyendo tabla...")
                ...
                try:
                    ...
                    wait.until(EC.presence_of_element_located(
                        (By.XPATH, '/html/body/form/div[3]/section/div/div/div[2]/div[5]/div/p/span')))
        ...
        def leearTablacontribuyente(contribuyente, paginas):
            ...
            def leearTablaBeauti(html):
                ...
                def RecolectarDatos():
                    ...
                    for row in rows:
                        ...
                        l2 = ["id", "anio", "cuota", "documentoCodigoPago", "totalDeuda", "dsctoOficSat",
                              "desctoWebBancos", "pagado", "deudaOficSat", "deudaWebBancos", "vencimiento", "estado",
                              "estadoDocNotificado", "estadoDocDeuda", "fechaNotificacion", "estadoExpediente",
                              "referencia"]
                ...
                if paginasTotales > 0:
                    ...
                    while pt <= paginasTotales + 1:
                        ...
                        print(
                            "Aqui se imprime el recorrido de las paginas cuand se tiene mas de contribuyentes {}".format(
                                result_reco))
                        print(
                            '/html/body/form/div[3]/section/div/div/div[2]/div[7]/div/div/div/div/table/tbody/tr[12]/td/table/tbody/tr/td[{}]/a'.format(
                                pt))
                        try:
                            wait.until(EC.presence_of_element_located((By.XPATH,
                                                                       '/html/body/form/div[3]/section/div/div/div[2]/div[7]/div/div/div/div/table/tbody/tr[12]/td/table/tbody/tr/td[{}]/a'.format(
            ...
            try:
                ...
                wait.until(EC.presence_of_element_located((By.XPATH,
                                                           '/html/body/form/div[3]/section/div/div/div[2]/div[4]/div/div/table/tbody/tr[' + str(
                                                               contribuyente) + ']/td[2]/a'))).click()
                try:
                    ...
                    espero = WebDriverWait(driver, 2)
                    mensaje = espero.until(
                        EC.presence_of_element_located((By.ID, 'ctl00_cplPrincipal_lblMensajeSinDatos'))).text
        ...
        driver.switch_to.frame(driver.find_element_by_id("fraRightFrame"))

        driver.find_element(By.XPATH, "/html/body/form/div[2]/section/div/div/div[2]/div[1]/div[2]/div[1]/div[3]/a/img").click()
        # wait.until(
        #     EC.presence_of_element_located((By.XPATH, '/html/body/form/div[2]/div[2]/nav/div/div/ul/li[2]/a'))).click()
        # print("1")
        # time.sleep(1)
        """
        ...
        try:
            time.sleep(1)
            wait.until(EC.presence_of_element_located(
                (By.ID, 'tipoBusqueda'))).click()
            print("2")
            time.sleep(1)
            # DNI por Defecto
            wait.until(EC.presence_of_element_located(
                (By.XPATH, '/html/body/form/div[3]/section/div/div/div[2]/div[2]/div/select/option[3]'))).click()
            print("3")
            # C.E
            if tipoDocumento == "2":
                wait.until(EC.presence_of_element_located(
                    (By.ID,
                     '/html/body/form/div[3]/section/div/div/div[2]/div[3]/div[2]/div/div[2]/div/div[2]/select/option[2]'))).click()
            # RUC
            if tipoDocumento == "3":
                wait.until(EC.presence_of_element_located(
                    (By.ID,
                     '/html/body/form/div[3]/section/div/div/div[2]/div[3]/div[2]/div/div[2]/div/div[2]/select/option[3]'))).click()
            # PASAPORTE
            if tipoDocumento == "4":
                wait.until(EC.presence_of_element_located(
                    (By.ID,
                     '/html/body/form/div[3]/section/div/div/div[2]/div[3]/div[2]/div/div[2]/div/div[2]/select/option[4]'))).click()
        ...
        while t < 3:
            ...
            if len(jsonParseCapcha) == 1:
                ...
                while p <= int(jsonParseCapcha) + 1:
                    ...
                    print("Respuesta de la funcion final - 1 {}".format(sad))
                    total.append(sad)
                ...
                if len(jsonParseCapcha) == 7:
                    ...
                    print("Respuesta de la funcion final - 2 {}".format(sad))
                    total.append(sad)
                    ...
                    time.sleep(5)
                    wait.until(EC.presence_of_element_located((By.NAME, 'ctl00$cplPrincipal$txtDocumento'))).clear()
                    wait.until(EC.presence_of_element_located((By.NAME, 'ctl00$cplPrincipal$txtDocumento'))).send_keys(
                        str(dni))
