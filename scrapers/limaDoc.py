...
class TestUntitled():
    def __init__(self, documento, webdrivertipo):
    ...
    def formatResult(self, resultado):
        ...
        print("cantidadDeArrglos", cantidadDeArrglos)
    ...
    def test_untitled(self):
        ...
        time.sleep(1)
        self.driver.find_element(By.XPATH, "//*[@id='tipoBusquedaPapeletas']/option[5]").click()

        self.driver.find_element(By.ID, "ctl00_cplPrincipal_txtDNI").click()

        # 4 | type | id=txtPlaca | D8L108 |
        self.driver.find_element(By.ID, "ctl00_cplPrincipal_txtDNI").send_keys(str(self.documento))
        self.leerCapcha()
        ...
        time.sleep(60)
        print("Fin click")
        # self.wait.until(EC.presence_of_element_located((By.ID, 'ctl00_cplPrincipal_grdEstadoCuenta')))
