...
class TestUntitled():
    def __init__(self, placa, webdriver2 ):
        print("en el init ")
        self.placa = placa
        self.webdriver2 = webdriver2
        if self.webdriver2 == 1:
            self.driver = webdriver.Remote(command_executor=os.getenv('WEBDRIVER'),
                                       desired_capabilities=DesiredCapabilities.CHROME)
        if self.webdriver2 == 2:
            self.driver = webdriver.Remote(command_executor=os.getenv('WEBDRIVER_RESPALDO'),
                                       desired_capabilities=DesiredCapabilities.CHROME)
        else:
            self.driver = webdriver.Remote(command_executor=os.getenv('WEBDRIVER_DEFAULT'),
                                       desired_capabilities=DesiredCapabilities.CHROME)
        ...
        def leerTabla(html):
            ...
            for row in rows:
                ...
                if len(cols) == 14:
                    ...
                    l2 = [ "placa", "reglamento", "falta", "documentoCodigoPago",
                          "fechaInfracEmision",
                          "importe", "gastCost",
                          "dscto",
                        "totalPagar",
            ...
            while f < paginas:
                ...
                try:
                    self.driver.find_element(By.XPATH,
                                             "/html/body/form/div[3]/section/div/div/div[2]/div[3]/div/div/div/div/div/table/tbody/tr[12]/td/table/tbody/tr/td['{}']/a".format(
                                                 f + 1)).click()
                    ...
                    print("No hay mas paginas por recorrer")
    ...
    def test_untitled(self):
        ...
        frame_element = self.driver.find_element(By.XPATH, "/html/body/div[1]/div/iframe")
        ...
        time.sleep(1)
        self.driver.find_element(By.XPATH, "/html/body/form/div[2]/section/div/div/div[2]/div[2]/div/select/option[2]").click()
        ...
        if paginasTotales == "null":
            ...
            print("---------------------------------------------------   NO ES NULL Y ESTAMOS ACÁ  -------------------------------------------------------")
